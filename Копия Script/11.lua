...
function OnTimer()
 SendToAll(BotName,"ЭТОТ Бот рекламирует!!!")
end;

function UserConnected()
 SendToAll(BotName,"Юзер зашёл с ником = "..curUser.sName.." IP = "..curUser.sIP)
end;

function UserDisconnected()
 SendToAll(BotName,"Юзер ушёл")
end;

function OpConnected()
 SendToAll(BotName,"К нам пришёл Админ, а ник не стажу =)")
end;

function OpDisconnected()
 SendToAll(BotName.."Нас покинал админ")
end;
